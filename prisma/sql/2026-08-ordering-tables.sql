...
CREATE TABLE IF NOT EXISTS "PurchaseOrderLine" (
    ...
    "receivedUnits" DOUBLE PRECISION,
    "soldInHistory" DOUBLE PRECISION,
    "onHand" DOUBLE PRECISION,
    "casesFull" DOUBLE PRECISION,
    "casesBalanced" DOUBLE PRECISION,
    "casesLean" DOUBLE PRECISION,
...
ALTER TABLE "PurchaseOrderLine"
  ...
  ADD COLUMN IF NOT EXISTS "receivedUnits" DOUBLE PRECISION,
  ADD COLUMN IF NOT EXISTS "soldInHistory" DOUBLE PRECISION,
  ADD COLUMN IF NOT EXISTS "onHand" DOUBLE PRECISION,
  ADD COLUMN IF NOT EXISTS "casesFull" DOUBLE PRECISION,
  ADD COLUMN IF NOT EXISTS "casesBalanced" DOUBLE PRECISION,
  ADD COLUMN IF NOT EXISTS "casesLean" DOUBLE PRECISION;

ALTER TABLE "PurchaseOrder"
  ADD COLUMN IF NOT EXISTS "version" TEXT NOT NULL DEFAULT 'full';
