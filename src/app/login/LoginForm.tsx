      ...
      <div className="lg:w-1/2 flex items-center justify-center p-6 lg:p-14">
        <div className="w-full max-w-sm">
          ...
          <form action={formAction} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-body-sm font-semibold text-on-surface mb-1">Email</label>
              <input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <label htmlFor="password" className="block text-body-sm font-semibold text-on-surface mb-1">Password</label>
              <input
                id="password"
                name="password"
                type="password"
